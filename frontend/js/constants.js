const contractAddress = "0x4041B2472E03b4Bb8a7b2593D2B1DC322e538033"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to Chubsters Incorporated!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = "Welcome to Chubsters Inc. Here you will find more info. Don't be scared and join Chubsters Incorporated, you won't regret it. If you want to check us out go to OpenSea"
...
const p_public_mint = "https://opensea.io/collection/chubstersinc";
...
const button_public_mint = "The minting is closed. Go check us out on OpenSea";
